...
namespace UnitTestProject1
{
    ...
    public class TestTriangle
    {
        ...
        {
            var area = Triangle.Set3Sides(5,3,4).GetArea();
        ...
        public void Test2SidesEqual()
        {
            ...
            var area = Triangle.Set1Angle2Sides(angleInRad, 4, 8).GetArea();
            Assert.AreEqual((double)16, area);
        }
        [TestMethod]
        public void Test2SidesUnequal()
        {
            var area = Triangle.Set1Angle2Sides(90, 4, 8).GetArea();
        ...
        public void Test1SideEqual()
        {
            ...
            var area = Triangle.Set2Angles1Side(  angleInRad1, angleInRad2, 8.9).GetArea();
